  ...
  return new ImageResponse(
    <div style={{ width: "100%", height: "100%", background: "#0B0D10", color: "#F5F5F5", display: "flex", flexDirection: "column", padding: "64px 76px", fontFamily: "Geist" }}>
      <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
        <div style={{ display: "flex", alignItems: "center", justifyContent: "center", width: 80, height: 80, border: "1px solid #34373D", borderRadius: 10, fontSize: 34, letterSpacing: -2 }}>MS<span style={{ color: "#38BDF8" }}>.</span></div>
        <div style={{ display: "flex", color: "#A1A1AA", fontSize: 22 }}>matthewsutiono.com</div>
      </div>
